        ...
        <div class = "bg-white/5 backdrop-blur-md rounded-lg mt-40 ml-40 m-auto w-full h-3/5">
            <div class="flex flex-row">
                <div class = "basis-3/5 gap-8 grid ml-10 text-amber-700 text-3xl " >
                    ...
                    <div class ="mt-10 h-12 bg-violet-900/50 rounded font-BlackOpsOne"  >
                        {pc_info.PcID}
    
                    </div>
                    <div class ="h-12  bg-violet-900/50 rounded font-BlackOpsOne">
                        {pc_info.EndTime}
                    </div>
                    ...
                    <div class ="flex flex-row">
                        <input class ="w-10 h-12 bg-violet-900/50 rounded font-BlackOpsOne" type ="number">
                ...
                <div class="flex flex-col basis-2/5 text-amber-700 text-3xl">
                    <div class ="">
                        <button class = "ml-10 mt-10 h-12 w-2/3 rounded-lg hover:bg-amber-600 active:bg-black  bg-violet-900/50 font-BlackOpsOne">
                            Bill
                        </button>
                    </div>
